...
/*
This program demonstrates how data is changed and calcuated with using integers,
modular arithmatic, the order of operations, combined assignment and math, and 
finally character math.
*/
...
int main() {
   ...
   //before the subraction.
   int order1 = 5 * 7 - 5;

   //This will evaluate to 3, as first the parenthasis is evaluated,
   //givint 2, which is then multiplied by 5, giving 10, and finally
   ...
   //7, and is multipled by 7 - 5, or two.
   int combine2 = 7;
   combine2 *= 7 - 5;
   
   //After tehse two lines, the character will have been transformed to
   //a 'g', as it was moved down 5 places.
   char char1 = 'b';
   char1 += 5;
   
   //After these two lines, the character will have been transformed from
   //a lowercase e to an upercase E, as mentioned in the notes.
   char char2 = 'e';
   char2 = char2 - 'a' + 'A';
